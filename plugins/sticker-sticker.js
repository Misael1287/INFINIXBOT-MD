...
let handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  try {
    ...
    if (/webp|image|video/g.test(mime)) {
      ...
      if (!img) throw `🔹Recuerda responder a una imagen o video con el comando ${usedPrefix + command}`
      let out
      try {
    ...
    else throw '🔹La conversion fallo, recuerda responder a una imagen ❗'
  }
}
handler.help = ['ꜱᴛɪᴄᴋᴇʀ <ᴇᴛɪqᴜᴇᴛᴀ>']
